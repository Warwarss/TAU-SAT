...
float pid_d[2]={0, 0};
/////////////////PID CONSTANTS/////////////////
double kp[2]={4, 0.5};//3.55
double ki[2]={0.001, 0.000};//0.003
double kd[2]={0.1, 2};//2.05
///////////////////////////////////////////////
double throttle=1450; //initial value of throttle to the motors
double upperlimit = 1750;
double lowerlimit = 1150;
float desired_angle = 5; //This is the angle in which we whant the
 ...
 * I only print the Y angle value for this test */
 ...
 delay(200);
  ...
  error_roll = Total_angle_x - desired_angle;
  error_pitch = Total_angle_y - desired_angle;
...
if(pwmBack > upperlimit)
{
  ...
  Serial.print(Total_angle_x); Serial.print(" Roll\t");
  Serial.print(Total_angle_y); Serial.print(" Pitch\n");
