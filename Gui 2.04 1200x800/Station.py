...
class Ui_MainWindow(QMainWindow):
    ...
    def Start_Data_Thread(self,port="COM5",baudrate=115200):
        ...
        if self.Thread_Active is False:
            ...
            self.Update_Thread = Thread.Worker1(self.Telemetri, self.Data_Thread)
    ...
    def CreateMenuBar(self):
        ...
        menubar.setGeometry(QtCore.QRect(0, 0, 1600, 26))
...
#         self.RPM_Value.setObjectName("RPM_Value")
        ...
        self.VBL.setGeometry(QtCore.QRect(0,100,320,240))
