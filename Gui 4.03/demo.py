...
class Ui_MainWindow(QMainWindow):
    ...
    def Dosya_Alindi_Fonk(self):
        self.Video_Durum1.setProperty("value", 100)
        self.Worker.ser.write(b"gg")
    def Dosya_Gonder_fonk(self):
        ...
        if self.Data_Thread_3.isRunning() is False:
            ...
            self.Worker3.finished.connect(self.Dosya_Alindi_Fonk)
    ...
    def Baslat_fonk(self):
        if self.Thread_Active is True:
            self.Worker.ser.write(b"ee")
    def Batarya_Update_Fonk(self, batarya_percentage):
        self.Batarya.setProperty("value", batarya_percentage)
        batarya_percentage = str(batarya_percentage)
        self.Batarya_Value.setText("%"+ batarya_percentage)
    def Ui_Update(self,display):
        ...
        if self.i == 2:
            try:
                ...
                pass
            self.Harita.delete_marker()
            self.Harita.add_marker(display[12], display[13])
            self.i = 0
        else:
            self.i = self.i + 1
    ...
    def Baglan_fonk(self):
        ...
        if self.Thread_Active is False and self.Data_Thread.isRunning() is False:
            ...
            self.Worker.Received.connect(self.Received_Fonk)
            ...
            self.Worker2.voltage.connect(self.Batarya_Update_Fonk)
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon(os.path.join(basedir, 'K.png')))
        ...
        self.Roll.setText("Roll=-10.24°")
        self.Pitch.setText("Pitch=7.96°")
        self.Yaw.setText("Yaw=222.17°")
