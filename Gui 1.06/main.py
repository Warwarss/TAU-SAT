...
class Window(QMainWindow):
    ...
    def Model_Update(self, data):
        self.Model.mesh.rotate(angle=float(data[0])/10, x=1,y=0,z=0)
        self.Model.mesh.rotate(angle=float(data[1])/10, x=0,y=1,z=0)
        self.Model.mesh.rotate(angle=float(data[2])/10, x=0,y=0,z=1)
